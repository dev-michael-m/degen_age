...
import ShardImg from '../assets/shards header.png';
...
const MintShard = () => {
    ...
    return (
        <div className='mint-container shards-bg'>
            ...
            <div className='mint-wrapper shard-mint-wrapper'>
                <div className='text-center'>
                    <h1>Lost Shards of Midrah</h1>
                    <h2>Mint Now!</h2>
                </div>
                <div>
                    <img src={ShardImg} width={300} height={300}></img>
                </div>
